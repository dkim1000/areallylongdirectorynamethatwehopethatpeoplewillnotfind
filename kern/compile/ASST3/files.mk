...
filedescriptor.o: ${S}/fs/vfs/filedescriptor.c
	${COMPILE.c} ${S}/fs/vfs/filedescriptor.c
SRCS+=${S}/fs/vfs/filedescriptor.c
OBJS+=filedescriptor.o

filemanager.o: ${S}/fs/vfs/filemanager.c
	${COMPILE.c} ${S}/fs/vfs/filemanager.c
SRCS+=${S}/fs/vfs/filemanager.c
OBJS+=filemanager.o

pidmanager.o: ${S}/thread/pidmanager.c
	${COMPILE.c} ${S}/thread/pidmanager.c
SRCS+=${S}/thread/pidmanager.c
OBJS+=pidmanager.o

processhandler.o: ${S}/thread/processhandler.c
	${COMPILE.c} ${S}/thread/processhandler.c
SRCS+=${S}/thread/processhandler.c
OBJS+=processhandler.o
...
segments.o: ${S}/vm/segments.c
	${COMPILE.c} ${S}/vm/segments.c
SRCS+=${S}/vm/segments.c
OBJS+=segments.o
